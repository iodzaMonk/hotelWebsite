  ...
  <div class="flex flex-col justify-center items-center">
    ...
    <?php if (!empty($hotels)) { ?>
      <?php foreach ($hotels as $hotel): ?>
        <a href="<?= 'index.php?controller=hotel&action=hotel&id=' . $hotel['id'] ?>" class="group block w-full">
    ...
    <a href="index.php?controller=hotel&action=add" class="group relative rounded-lg px-5 py-3 font-medium bg-white/0 text-white border border-white/30
